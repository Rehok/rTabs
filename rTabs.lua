...
-- This is currently way to do it until i hooksecurefunc them all or use my frame  option as some
-- functions arent functions according to hooksecurefunc, This is a terrible way to do it all but whatever.
